...
{    
    ...
    public enum TPCANStatus : uint
    {
        ...
        /// <summary>
        /// Resource (FIFO, Client, timeout_ms) cannot be created
        /// </summary>
    ...
    public static class PCANBasic
    {
        ...
        /// <param name="Btr0Btr1">The speed for the peakComm (BTR0BTR1 code)</param>
        ...
        /// <param name="BitrateFD">The speed for the peakComm (FD bit rate string)</param>
