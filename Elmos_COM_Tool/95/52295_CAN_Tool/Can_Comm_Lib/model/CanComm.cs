...
namespace Can_Comm_Lib
{
    public class CanComm
    {
        ...
        private CanCommAdapter _adapter = CanCommAdapter.NONE;
        ...
        public void Open(CanCommAdapter adapter, CanCommBitrate bitrate)
        {
            switch (adapter)
            {
        ...
        public void Open(CanCommBitrate bitrate)
        {
            switch (_adapter)
            {
                case CanCommAdapter.PEAK: _peakComm.Open(bitrate); break;
                case CanCommAdapter.VECTOR: _vectorComm.Open(bitrate); break;
            }
        }
